...
OBJECTS=nespal.o mapper_info.o rom.o sound.o sys.o nes.o vid.o config.o M6502.o global.o filters.o utility.o font.o filesystem.o timer.o ui.o ag.o main.o
INCLUDEDIRS= -IM6502
DEFINES=$(FUSE_FLAGS)
